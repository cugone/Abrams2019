...
namespace a2de {
    ...
    template<>
    struct a2de::TypeUtils::is_incrementable_enum_type<RHIOutputMode> : std::true_type {};
    ...
    template<>
    struct a2de::TypeUtils::is_bitflag_enum_type<PipelineStage> : std::true_type {};
    ...
    template<>
    struct a2de::TypeUtils::is_bitflag_enum_type<BufferUsage> : std::true_type {};
    ...
    template<>
    struct a2de::TypeUtils::is_bitflag_enum_type<BufferBindUsage> : std::true_type {};
    ...
    template<>
    struct a2de::TypeUtils::is_bitflag_enum_type<BlendColorWriteEnable> : std::true_type {};
