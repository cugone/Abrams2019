...
#else
    [[nodiscard]] virtual unsigned int GetMatrixBufferIndex() const noexcept = 0;
    [[nodiscard]] virtual unsigned int GetTimeBufferIndex() const noexcept = 0;
    [[nodiscard]] virtual unsigned int GetLightingBufferIndex() const noexcept = 0;
    [[nodiscard]] virtual unsigned int GetConstantBufferStartIndex() const noexcept = 0;
    [[nodiscard]] virtual unsigned int GetStructuredBufferStartIndex() const noexcept = 0;
    [[nodiscard]] virtual unsigned int GetMaxLightCount() const noexcept = 0;
#endif
...
#else
    [[nodiscard]] unsigned int GetMatrixBufferIndex() const noexcept override {};
    [[nodiscard]] unsigned int GetTimeBufferIndex() const noexcept override {};
    [[nodiscard]] unsigned int GetLightingBufferIndex() const noexcept override {};
    [[nodiscard]] unsigned int GetConstantBufferStartIndex() const noexcept override {};
    [[nodiscard]] unsigned int GetStructuredBufferStartIndex() const noexcept override {};
    [[nodiscard]] unsigned int GetMaxLightCount() const noexcept override {};
#endif
